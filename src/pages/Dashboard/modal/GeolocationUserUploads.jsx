...
import { convertToHumanReadable, encryptText, getUserBillboardUploads } from '../../../data/lib';
                    ...
                    {selectedBillboard && (
                        ...
                        >
                            <div className="p-2">
                                ...
                                <Link to={`/billboard/${encryptText(selectedBillboard.more.billboardId)}/history`} className="btn btn-subtle-info me-1 mb-1 form-control" type="button"><History className='me-2' size={15} />show history</Link>
                            </div>
                        </InfoWindow>
                    )}
                </Map>

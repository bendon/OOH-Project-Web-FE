          ...
          <div className="navbar-vertical-content">
            <ul className="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li className="nav-item">
                ...
                <div className="nav-item-wrapper">
                    <NavLink className="nav-link label-1" to="/file-gallery" role="button" data-bs-toggle="" aria-expanded="false">
                        <div className="d-flex align-items-center">
                            <span className="nav-link-icon"> <Images size={18} className='icon'/> </span>
                            <span className="nav-link-text-wrapper"><span className="nav-link-text">Gallery</span></span>
                        </div>
                    </NavLink>
                </div>
              </li>

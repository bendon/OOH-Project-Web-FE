      ...
      <div className="navbar-vertical-content">
        <ul className="navbar-nav flex-column" id="navbarVerticalNav">
          <li className="nav-item">
            ...
            <div className="nav-item-wrapper">
                <Link className="nav-link label-1" to="/bill-board-analysis" role="button" data-bs-toggle="" aria-expanded="false">
                    <div className="d-flex align-items-center">
            ...
            <div className="nav-item-wrapper">
                <Link className="nav-link label-1" to="/team-analysis" role="button" data-bs-toggle="" aria-expanded="false">
                    <div className="d-flex align-items-center">
          ...
          <li className="nav-item">
            ...
            <div className="nav-item-wrapper">
                <Link className="nav-link label-1" to="manage-boards/create" role="button" data-bs-toggle="" aria-expanded="false">
                    <div className="d-flex align-items-center">
            ...
            <div className="nav-item-wrapper">
                <Link className="nav-link label-1" to="/manage-boards/map-location" role="button" data-bs-toggle="" aria-expanded="false">
                    <div className="d-flex align-items-center">

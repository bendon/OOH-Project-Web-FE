              ...
              <div className="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border" aria-labelledby="navbarDropdownUser">
                <div className="card position-relative border-0">
                  ...
                  <div className="card-footer p-0 border-top border-translucent">
                    ...
                    <hr /> */}
                    <div className="px-3 py-3"> <a className="btn btn-phoenix-secondary d-flex flex-center w-100" href="#!"> <span className="me-2" data-feather="log-out"> </span>Sign out</a></div>
                  </div>
                </div>
              </div>
            </li>
